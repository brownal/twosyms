...
breaks <- c(seq(0, 365, length.out=7), 1.5*365, 2*365, 5*365, 10*365, 15*365, 20*365)
...
exclusion_time_mat[1, 1] <- sum(!(sim_tol_exclusion$posGrH100d & sim_tol_exclusion$noClimAll100d)) / nrow(sim_tol_exclusion) * 100
exclusion_time_mat[2, 1] <- sum(!(sim_sen_exclusion$posGrH100d & sim_sen_exclusion$noClimAll100d)) / nrow(sim_sen_exclusion) * 100


# Barplot
par(cex.axis=0.75)
barplot(exclusion_time_mat,
	names=c("Host dies", paste0(seq(0, 10, 2), "-", seq(2, 12, 2), " mo"), "1-1.5 yr", "1.5-2 yr", "2-5 yr", "5-10 yr", "10-15 yr", "15-20 yr", ">20 yr"),
...
#pdf("Time_to_competitive_exclusion.pdf", 12, 12)
...
plot(sim_tol_exclusion$L[sim_tol_exclusion$reachedThreshold & sim_tol_exclusion$posGrH100d & sim_tol_exclusion$noClimAll100d],
	sim_tol_exclusion$exclusionTime[sim_tol_exclusion$reachedThreshold  & sim_tol_exclusion$posGrH100d & sim_tol_exclusion$noClimAll100d]/365,
...
points(sim_sen_exclusion$L[sim_sen_exclusion$reachedThreshold & sim_sen_exclusion$posGrH100d & sim_sen_exclusion$noClimAll100d],
	sim_sen_exclusion$exclusionTime[sim_sen_exclusion$reachedThreshold & sim_sen_exclusion$posGrH100d & sim_sen_exclusion$noClimAll100d]/365,
...
#pdf("Supplement_prey_competitive_exclusion_time.pdf", 6, 6)
