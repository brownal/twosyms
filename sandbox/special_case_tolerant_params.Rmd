...
points_S_lives = rescue_tol_param[rescue_tol_param$reason == "S_lives",][1:min(500, sum(rescue_tol_param$reason == "S_lives")),];
...
points_T_dominates = rescue_tol_param[rescue_tol_param$reason == "T_dominates",][1:min(500, sum(rescue_tol_param$reason == "T_dominates")),];

points_rescue = rescue_tol_param[(rescue_tol_param$reason == "rescue") & (rescue_tol_param$rescue_time <= 100),][1:min(500,
      sum((rescue_tol_param$reason == "rescue") & (rescue_tol_param$rescue_time <= 100))),];

points_T_dies = rescue_tol_param[(rescue_tol_param$reason == "T_dies") | ((rescue_tol_param$reason == "rescue") & (rescue_tol_param$rescue_time > 100)),][1:min(500,
      sum((rescue_tol_param$reason == "T_dies") | ((rescue_tol_param$reason == "rescue") & (rescue_tol_param$rescue_time > 100)))),];
```
...
p_alphabeta <- plot(recovery_time_model, pars=c("alpha", "beta_L", "beta_N", "beta_X", "beta_kCO2", "beta_kNPQ", "beta_astar", "beta_jSGm", "beta_jCPm", "beta_kROS", "beta_b"));

p_gammaL <- plot(recovery_time_model, pars=c("gamma_LxL", "gamma_LxN", "gamma_LxX", "gamma_LxkCO2", "gamma_LxkNPQ", "gamma_Lxastar", "gamma_LxjSGm", "gamma_LxjCPm", "gamma_LxkROS", "gamma_Lxb"));

p_gammaN <- plot(recovery_time_model, pars=c("gamma_NxN", "gamma_NxX", "gamma_NxkCO2", "gamma_NxkNPQ", "gamma_Nxastar", "gamma_NxjSGm", "gamma_NxjCPm", "gamma_NxkROS", "gamma_Nxb"));

p_gammaX <- plot(recovery_time_model, pars=c("gamma_XxX", "gamma_XxkCO2", "gamma_XxkNPQ", "gamma_Xxastar", "gamma_XxjSGm", "gamma_XxjCPm", "gamma_XxkROS", "gamma_Xxb"));

p_gammakCO2 <- plot(recovery_time_model, pars=c("gamma_kCO2xkCO2", "gamma_kCO2xkNPQ", "gamma_kCO2xastar", "gamma_kCO2xjSGm", "gamma_kCO2xjCPm", "gamma_kCO2xkROS", "gamma_kCO2xb"));

p_gammakNPQ <- plot(recovery_time_model, pars=c("gamma_kNPQxkNPQ", "gamma_kNPQxastar", "gamma_kNPQxjSGm", "gamma_kNPQxjCPm", "gamma_kNPQxkROS", "gamma_kNPQxb"));

p_gammaastar <- plot(recovery_time_model, pars=c("gamma_astarxastar", "gamma_astarxjSGm", "gamma_astarxjCPm", "gamma_astarxkROS", "gamma_astarxb"));

p_gammajSGm <- plot(recovery_time_model, pars=c("gamma_jSGmxjSGm", "gamma_jSGmxjCPm", "gamma_jSGmxkROS", "gamma_jSGmxb"));

p_gammarest <- plot(recovery_time_model, pars=c("gamma_jCPmxjCPm", "gamma_jCPmxkROS", "gamma_jCPmxb", "gamma_kROSxkROS", "gamma_kROSxb", "gamma_bxb"));

```

## Summary of Stan results

```{r}

p_alphabeta
grid.arrange(p_gammaL, p_gammaN, p_gammaX, p_gammakCO2, nrow=2)
grid.arrange(p_gammakNPQ, p_gammaastar, p_gammajSGm, p_gammarest, nrow=2)


print(summary(recovery_time_model, probs = c(0.50))$summary)
