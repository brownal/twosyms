...
#library(coRal) # commented out to make sure I don't overwrite my changes to run_coral
library(foreach)
library(parallel)
library(doParallel)
library(plot.matrix)
...
# On 7/23/2020 I'm running this with the equation for rhoN changed to include 1/yC.
(Did this with the trace function. Had to call it outside of this document.)
...
#
 my_dapc <- dapc(dapc_x, dapc_grp, n.pca=8, n.da=4)
