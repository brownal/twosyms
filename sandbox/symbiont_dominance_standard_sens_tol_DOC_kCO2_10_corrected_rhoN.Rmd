...
search_params <- data.frame("L"=runif(30000, 5, 60),       # Light, choose values between 5 and 40
                            "logN"=runif(30000, -9, -7),     # DIN, choose values between 0 and 6e-6
...
search_params <- data.frame("L"=runif(30000, 5, 60),       # Light, choose values between 5 and 40
                            "N"=10^runif(30000, -9, -7),     # DIN, choose values between 0 and 6e-6
                            "X" = runif(30000, 0, 4e-7),     # Food, choose values between 0 and 4e07
                            "kCO2" = rep(10, 30000))   # Host carbon-concentrating ability, choose value of 10
...
### DAPC analysis _using the log of environmental variables_ of the dominant symbiont when 2 symbionts are present

```{r}
dapc_sims <- no_doc_sims
dapc_sims$L <- log(no_doc_sims$L)
dapc_sims$N <- log(no_doc_sims$N)
dapc_sims$X <- log(no_doc_sims$X)
...
### Plot _on DAPC axes found using the log of environmental variables_ of the dominant symbiont when 2 symbionts are present in the host
...
search_params <- data.frame("L"=runif(150000, 5, 60),       # Light, choose values between 5 and 40
                            "N"=runif(150000, 1e-7, 6e-6),     # DIN, choose values between 0 and 6e-6
...
### C-N limitation after the transition to positive host growth
