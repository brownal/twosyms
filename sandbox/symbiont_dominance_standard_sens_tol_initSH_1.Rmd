...
scatter(mydapc_clust, cell = 0, cstar = 0, mstree = FALSE, lwd = 2, lty = 2, axesell=TRUE, scree.da=FALSE, inset.pca=TRUE,
      col=c("#000000", "#000000", "#000000", "#648FFF", "#FFB000", "#FFB000", "#FFB000"), pch=c(0, 7, 15, 2, 1, 10, 16))
arrows(x0=0, y0=0, x1=mydapc$var.load[1,1], y1=mydapc$var.load[1,2])
text(x=mydapc$var.load[1,1]/2, y=mydapc$var.load[1,2]/2, labels="Light", pos=3)
arrows(x0=0, y0=0, x1=mydapc$var.load[2,1], y1=mydapc$var.load[2,2])
text(x=mydapc$var.load[2,1]/1, y=mydapc$var.load[2,2]/2, labels="Nitrogen", pos=4)
...
# plot the subclusters
print("No survival subclusters")
plot(dapc_sims[dapc_sims$dominant_symb=="No_survival", c("L", "X", "N", "kCO2")], col="black", pch=c(0, 15)[NS_clust])

print("Tolerant symb. dominates hosts subclusters")
plot(dapc_sims[dapc_sims$dominant_symb=="Tolerant", c("L", "X", "N", "kCO2")], col="#FFB000", pch=c(1, 16)[T_clust])
