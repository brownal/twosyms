...
mylda <- lda(dominant_symb ~ L + N + X, lda_sims, tol=1e-8)
...
mydapc <- dapc(dapc_sims[, c("L", "N", "X")], grp=dapc_sims$dominant_symb, var.contrib=TRUE, var.loadings=TRUE, scale = TRUE, n.pca = 3, n.da = 2)
