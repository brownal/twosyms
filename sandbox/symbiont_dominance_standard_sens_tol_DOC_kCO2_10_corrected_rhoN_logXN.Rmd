...
search_params <- data.frame("L"=runif(30000, 5, 60),       # Light, choose values between 5 and 40
                            "N"=10^runif(30000, -8, -5),     # DIN, choose values between 0 and 6e-6
                            "X" = 10^runif(30000, -8, -6.4),     # Food, choose values between 0 and 4e07
...
search_params <- expand.grid("L"=seq(5, 60, 0.5),       # Light, choose values between 5 and 40
                            "N"=10^seq(-8, -5, 0.05),     # DIN, choose values between 0 and 6e-6
...
search_params <- data.frame("L"=runif(150000, 5, 60),       # Light, choose values between 5 and 40
                            "N"=10^runif(150000, -8, -5),     # DIN, choose values between 0 and 6e-6
                            "X" = 10^runif(150000, -8, -6.4),     # Food, choose values between 0 and 4e07
